...
namespace g3
{
    ...
    public static class FastPointWinding
    {
        ...
        public static double ExactEval(ref Vector3d x, ref Vector3d xn, ref double xA, ref Vector3d q)
        {
            Vector3d dv = (x - q);
        ...
        public static double Order1Approx(ref Vector3d x, ref Vector3d p, ref Vector3d xn, ref double xA, ref Vector3d q)
        {
            Vector3d dpq = (p - q);
            double len = dpq.Length;
            double len3 = len * len * len;
        ...
        // x is dipole point, p is 'center' of cluster of dipoles, q is evaluation point
        public static double Order2Approx(ref Vector3d x, ref Vector3d p, ref Vector3d xn, ref double xA, ref Vector3d q)
        {
            Vector3d dpq = (p - q);
            Vector3d dxp = (x - p);

...
namespace g3
{
    public readonly struct Line2d
    {
        ...
        public static Line2d FromPoints(Vector2d p0, Vector2d p1) =>
            new Line2d(p0, (p1 - p0).Normalized);
        ...
        public Vector2d ClosestPoint(in Vector2d p)
        {
        ...
        public static implicit operator Line2d(in Line2f v) => new Line2d(v.Origin, v.Direction);

        public static explicit operator Line2f(in Line2d v) =>
            new Line2f((Vector2f)v.Origin, (Vector2f)v.Direction);
    }

    public readonly struct Line2f
    {
        ...
        public Vector2f ClosestPoint(in Vector2f p)
        {
